...
class OutstationRoundTripScreen extends StatefulWidget {
  const OutstationRoundTripScreen({super.key});

  @override
  State<OutstationRoundTripScreen> createState() => _OutstationRoundTripScreenState();
}

class _OutstationRoundTripScreenState extends State<OutstationRoundTripScreen> {
        ...
        child: Column(
                ...
                children: [
                  Row(
                    children: [
                      GestureDetector(
                        onTap: () {
                         Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>OutstationTripScreen()),);
                        },
                        child: Container(
                          width: 164.0,
                          height: 85.52,
                             ...
                             GestureDetector(
                              onTap: (){
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                                    String userEnteredLocation = destinationAddress;
                                    return AlertDialog(
                                      content: Column(
                                        mainAxisSize: MainAxisSize.min,
                                        children: <Widget>[
          ...
          BottomNavigation(
              items: [
                ...
                BottomNavItem(imagepath: "images/trip-icon.png", text: "My Trip"),
                BottomNavItem(imagepath: "images/person-icon.png", text: "Account"),
