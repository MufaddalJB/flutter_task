...
import 'package:flutter_task/screens/local_trip_screen.dart';

class OutstationTripScreen extends StatefulWidget {
  const OutstationTripScreen({super.key});

  @override
  State<OutstationTripScreen> createState() => _OneWayTripScreenState();
}

class _OneWayTripScreenState extends State<OutstationTripScreen> {
  bool value = true;
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const InfoContainer(
                              ...
                              title: "Destination",
                              description: "Lucknow, Utter Pradesh"),
                          const InfoContainer(
