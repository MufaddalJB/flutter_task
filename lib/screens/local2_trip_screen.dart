...
class LocalTrip2Screen extends StatefulWidget {
  const LocalTrip2Screen({super.key});

  @override
  State<LocalTrip2Screen> createState() => _LocalTrip2ScreenState();
}

class _LocalTrip2ScreenState extends State<LocalTrip2Screen> {
